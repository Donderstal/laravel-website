...
@endif
    <div class="top-bar grid-x">
        ...
        <div class="cell small-6 large-2 large-order-1 header-subsection">
            ...
            @if( Route::currentRouteName() === 'landing-page' )
                <img class="clickable__logo logo-white navbar__company-logo" src="{{ mix('img/ui-icons/logo-laravel.png') }}">

                <img class="clickable__logo logo-black navbar__company-logo__do-not-display" src="{{ mix('img/ui-icons/logo-laravel.png') }}">
            @else
                <img class="clickable__logo logo-white navbar__company-logo__do-not-display" src="{{ mix('img/ui-icons/logo-laravel.png') }}">

                <img class="clickable__logo logo-black navbar__company-logo" src="{{ mix('img/ui-icons/logo-laravel.png') }}">
            @endif
            </div>
        </div>
