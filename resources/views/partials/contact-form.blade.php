       ...
       @if ($errors->any())
        ...
        <form action="/contact" method="post" class="grid-x general-info__form">
            ...
            <div class="cell small-12">
                ...
                <label class="checkbox-label" for="voorwaarden" >Ja, ik ga akkoord met de</label> <a class="checkbox-label" id="voorwaarden_file" target="_blank" href="{{ route('layouts.privacy_statement') }}">voorwaarden. </a>
            </div>
